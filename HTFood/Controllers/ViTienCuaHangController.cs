...
namespace HTFood.Controllers
{
    public class ViTienCuaHangController : Controller
    {
        ...
        // GET: ViTienCuaHang/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ViTienCuaHang/Create
